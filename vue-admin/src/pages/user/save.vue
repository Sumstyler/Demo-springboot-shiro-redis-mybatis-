        ...
        <el-col :span="8">
          <el-form ref="form" :model="form" :rules="rules" label-width="100px">
            <el-form-item label="用户名:" prop="username">
              <el-input v-model="form.username" placeholder="请输入内容" :disabled="type == 'edit'" style="width: 250px;"></el-input>
            </el-form-item>
            ...
            <el-form-item label="联系方式:" prop="tel">
              <el-input v-model="form.tel" placeholder="请输入联系方式" style="width: 250px;"></el-input>
            </el-form-item>
    ...
    data(){
      return {
        ...
        rules: {
          ...
          age:[{required: true, message: '年龄不能为空',trigger: 'blur'},{type: 'number', message: '年龄必须为数字值',trigger: 'blur'}],
